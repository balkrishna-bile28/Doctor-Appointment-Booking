...
const MyAppointments = () => {
  ...
  // const paymentOnline = async (appointmentId) => {
  //   try {
  //     const { data } = await axios.post(
  //       backendUrl + "/api/user/payment-online",
  //       { appointmentId },
  //       { headers: { token } }
  //     );
  //     if (data.success) {
    ...
    <div>
      ...
      <div>
        {appointments.map((item, index) => (
          <div
            className="grid grid-cols-1 grid-cols-2 gap-4 sm:flex sm:gap-6 py-2 border-b"
            key={index}
          >
            <div>
              <img
            ...
            <div className="flex-1 text-sm text-zinc-600">
              ...
              <p>{item.speciality}</p>
              <p className="font-medium mt-1 text-zinc-700">Adress</p>
